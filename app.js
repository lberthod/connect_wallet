...
var url2 = "https://jsonplaceholder.typicode.com/users/1";
 ...
 function toggleButton() {
   ...
   btnana.addEventListener('click', fetchAsync (url))
 }
 ...
 async function loginWithMetaMask() {
  ...
  console.log("WAllet + " + walletAddress);
   url = "https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xa81a72296C819e81E3AA0a5bC2130f2Ab43C872a&address="+walletAddress+"&tag=latest&apikey=KQBDX24I5CM7QUHUKE6PFWG1YH8UN28W4S"
  ...
  const elem1 = document.getElementById('btnana');
...
async function fetchAsync (url) {
  ...
  const printAddress = async () => {
    ...
    if(a.result >1){
      userInfo.innerText = ' Vous avez des tokens NBSW-5MZN :) !';
    }
    if(a.result <1){
      userInfo.innerText = ' Vous n avez pas des tokens NBSW-5MZN :(';
    }
  };
...
async function loginO() {
  var url = "https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xa81a72296C819e81E3AA0a5bC2130f2Ab43C872a&address="+walletAddress+"&tag=latest&apikey=KQBDX24I5CM7QUHUKE6PFWG1YH8UN28W4S"
